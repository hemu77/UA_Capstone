"""
Utilities for loading and converting real-world comparison datasets.

The generated graphs are synthetic. This file helps bring reference datasets
into the same general format so the project can compare real and generated
...
def make_graphs_from_dynetml_file(fn, min_val=1, max_val=1e10):
    ...
    http://www.casos.cs.cmu.edu/projects/dynetml/
    """
    # Many of the reference datasets ship in DyNetML, so this parser converts
    # them into NetworkX graphs used elsewhere in the repo.
